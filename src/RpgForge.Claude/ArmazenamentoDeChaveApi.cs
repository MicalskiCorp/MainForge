...
public sealed class ArmazenamentoDeChaveApi
{
    ...
    /// </summary>
    private static readonly byte[] EntropiaDoAplicativo = Encoding.UTF8.GetBytes("RpgForge.ChaveApi.v1");

    public string CaminhoDoArquivo { get; }

    /// <param name="caminhoDoArquivo">
    /// Onde gravar o arquivo cifrado. Se omitido, usa
    /// <c>%APPDATA%\RpgForge\chave-api.dat</c>. O parâmetro existe para os testes poderem
