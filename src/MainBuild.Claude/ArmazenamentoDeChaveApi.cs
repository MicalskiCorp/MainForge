...
public sealed class ArmazenamentoDeChaveApi
{
    ...
    /// </summary>
    private static readonly byte[] EntropiaDoAplicativo = Encoding.UTF8.GetBytes("MainBuild.ChaveApi.v1");

    public string CaminhoDoArquivo { get; }

    /// <param name="caminhoDoArquivo">
    /// Onde gravar o arquivo cifrado. Se omitido, usa
    /// <c>%APPDATA%\MainBuild\chave-api.dat</c>. O parâmetro existe para os testes poderem
