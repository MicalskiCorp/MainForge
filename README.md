...
**[Baixar o MainForge 1.5.2](https://github.com/MicalskiCorp/MainForge/releases/download/v1.5.2/MainForge-1.5.2-win-x64.zip)**
...
```powershell
Get-FileHash .\MainForge-1.5.2-win-x64.zip -Algorithm SHA256
```
...
./publicar.ps1 -Versao 1.5.2              # gera o .zip do release (win-x64, executável único)
```
